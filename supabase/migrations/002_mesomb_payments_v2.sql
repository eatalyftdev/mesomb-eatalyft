...
-- Compatibility for projects where public.payments already existed with an
-- older schema. CREATE TABLE IF NOT EXISTS does not add missing columns.
ALTER TABLE public.payments
  ADD COLUMN IF NOT EXISTS firebase_ref TEXT,
  ADD COLUMN IF NOT EXISTS reference TEXT,
  ADD COLUMN IF NOT EXISTS user_id TEXT,
  ADD COLUMN IF NOT EXISTS service_type TEXT,
  ADD COLUMN IF NOT EXISTS service_id TEXT,
  ADD COLUMN IF NOT EXISTS mesomb_pk TEXT,
  ADD COLUMN IF NOT EXISTS fin_trx_id TEXT,
  ADD COLUMN IF NOT EXISTS provider_ref TEXT,
  ADD COLUMN IF NOT EXISTS service TEXT,
  ADD COLUMN IF NOT EXISTS b_party TEXT,
  ADD COLUMN IF NOT EXISTS amount_xaf NUMERIC(14,2),
  ADD COLUMN IF NOT EXISTS amount NUMERIC(14,2),
  ADD COLUMN IF NOT EXISTS fees NUMERIC(14,2) DEFAULT 0,
  ADD COLUMN IF NOT EXISTS trxamount NUMERIC(14,2),
